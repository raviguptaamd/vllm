...
class AiterExperts(mk.FusedMoEExpertsModular):
    ...
    def _supports_quant_scheme(
        ...
        if weight_key == kMxfp4Static:
            ...
            # v3 parity: gfx942 K3 int4-SiTU runs through this EP-safe modular
            # expert (AiterExperts). The v4 rebase dropped on_gfx942 here, which
            # forced K3 to OCP EMULATION on gfx942. Restore it.
